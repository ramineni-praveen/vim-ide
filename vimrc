...
" ================ NERDTree mappings ============================
"RP - Modified NERDTreeToggle shortcuts.
" Mapping to NERDTree
...
" setting ctags 
set tags+=/usr/include/c++/4.4.7/tags
...
" p4_1777 tags
set tags+=~/perforce/p4_1777/in2_complete/Interfaces/tags_Interfaces
...
"RP Added these lines to make it green menu for Omni Completion
    highlight   clear
